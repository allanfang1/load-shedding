...
This document explains the design, runtime flow, extension points, and operational usage of the `src/modelling_s_v2` module.
...
See 4.4 for more details. Assuming working directory is `src/modelling_s_v2`. 
